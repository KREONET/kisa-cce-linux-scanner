...
The separate patcher provides [kisa-cce-patch(8)](https://github.com/KREONET/kisa-cce-linux-patcher/blob/main/man/kisa-cce-patch.8).
...
| Command manuals | Section 8 files under `man/`. |
